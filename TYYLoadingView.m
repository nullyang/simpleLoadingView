...
//  Pods
//
//  Created by Null on 17/1/6.
//
//

#import "TYYLoadingView.h"
#import <EFFoundation/EFFoundation.h>

@interface TYYLoadingView()<CAAnimationDelegate>
...
+ (void)showLoadingView{
    [self showLoadingViewInView:keyWindow()];
}

+ (void)showLoadingViewInView:(UIView *)view{
    [self hideLoadingViewInView:view];
    TYYLoadingView *loadView = [[TYYLoadingView alloc]initWithFrame:CGRectMake(0, 0, view.width, view.height)];
    [view addSubview:loadView];
}

+ (void)hideLoadingView{
    [self hideLoadingViewInView:keyWindow()];
}
